...
export const ImagemPrecoCompra = styled.section`
    width: 40px;
    height: 40px;
    background-image: url(${Compra});
    background-position: center;
    background-repeat: no-repeat;
    background-size: 80%;
    position: absolute;
    left: 5%;
`;
export const ImagemPrecoVenda = styled.section`
    width: 40px;
    height: 40px;
    background-image: url(${Venda});
    background-position: center;
    background-repeat: no-repeat;
    background-size: 80%;
    position: absolute;
...
export const ImagemMarca = styled.section`
    width: 40px;
    height: 40px;
